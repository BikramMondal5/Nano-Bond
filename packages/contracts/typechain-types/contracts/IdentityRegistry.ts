...
export interface IdentityRegistryInterface extends Interface {
  ...
  decodeFunctionResult(functionFragment: "idToWallet", data: BytesLike): Result;
...
export namespace IdentityVerifiedEvent {
  export type InputTuple = [wallet: AddressLike, nationalIdHash: BytesLike];
  export type OutputTuple = [wallet: string, nationalIdHash: string];
  export interface OutputObject {
    wallet: string;
...
export interface IdentityRegistry extends BaseContract {
  ...
  idToWallet: TypedContractMethod<[arg0: BytesLike], [string], "view">;

  isVerified: TypedContractMethod<[wallet: AddressLike], [boolean], "view">;

  nationalIds: TypedContractMethod<[arg0: AddressLike], [string], "view">;

  register: TypedContractMethod<
    [wallet: AddressLike, nationalIdHash: BytesLike],
    [void],
    "nonpayable"
  >;
  ...
  revoke: TypedContractMethod<[wallet: AddressLike], [void], "nonpayable">;
  ...
  filters: {
    ...
    "IdentityVerified(address,bytes32)": TypedContractEvent<
      IdentityVerifiedEvent.InputTuple,
      IdentityVerifiedEvent.OutputTuple,
      IdentityVerifiedEvent.OutputObject
    >;
