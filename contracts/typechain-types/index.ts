...
export type { IdentityRegistryV2 } from "./contracts/IdentityRegistryV2";
export { IdentityRegistryV2__factory } from "./factories/contracts/IdentityRegistryV2__factory";
export type { InvestmentGateway } from "./contracts/InvestmentGateway.sol/InvestmentGateway";
export { InvestmentGateway__factory } from "./factories/contracts/InvestmentGateway.sol/InvestmentGateway__factory";
export type { ITreasury } from "./contracts/InvestmentGateway.sol/ITreasury";
export { ITreasury__factory } from "./factories/contracts/InvestmentGateway.sol/ITreasury__factory";
