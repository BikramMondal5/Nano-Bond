...
export interface IdentityRegistryV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "KYC_VERIFIER_ROLE"
...
export interface IdentityRegistryV2 extends BaseContract {
  connect(runner?: ContractRunner | null): IdentityRegistryV2;
  waitForDeployment(): Promise<this>;

  interface: IdentityRegistryV2Interface;
  ...
  filters: {
    "IdentityExpired(address)": TypedContractEvent<
      IdentityExpiredEvent.InputTuple,
      IdentityExpiredEvent.OutputTuple,
      IdentityExpiredEvent.OutputObject
    >;
