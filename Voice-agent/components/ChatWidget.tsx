...
const FALLBACK_RESPONSES = [
    "I'm the NanoBond Advisor. I can help you with questions about investing in government bonds.",
    "NanoBond offers a secure way to invest in fractional government bonds using blockchain technology.",
    "You can start investing with as little as $10 using standard stablecoins like USDT.",
    "Our platform ensures transparency and security through tokenized bond assets.",
    "Feel free to ask me about setting up your wallet or choosing a bond to invest in."
];

const NANOBOND_AI_PROMPT = `You are the NanoBond Advisor, an AI assistant for the NanoBond platform. Your purpose is to guide users through investing in fractional government bonds.
Your tone should be professional, helpful, and financially accessible.

Key Context:
- NanoBond allows users to invest in sovereign bonds using cryptocurrency (USDT).
- Users can browse bonds, view their portfolio, and perform KYC verification.
- You can explain concepts like yield, maturity, and fractional investing.

Instructions:
- Provide clear, concise answers to financial questions.
- If asked about the platform, explain it is a blockchain-based government bond marketplace.
- Guide users to the Dashboard or Invest page if they want to get started.
- Be secure: never ask for private keys or sensitive personal passwords.`;
...
const ChatWidget = () => {
    ...
    const getDynamicSystemPrompt = () => {
        ...
        return `${NANOBOND_AI_PROMPT}${bondContext}`;
    };
                                    ...
                                    <div className="flex items-center justify-center h-full px-6">
                                        ...
                                        >
                                            <p className="text-gray-100 text-sm leading-relaxed">
                                                Hi there! I'm <span className="text-purple-400 font-semibold">NanoBond Advisor</span>. I can help you with your investment journey. What would you like to know?
                                            </p>
