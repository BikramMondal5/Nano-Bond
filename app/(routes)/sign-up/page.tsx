...
import { Rocket, Wallet, Loader2, ArrowRight, User, Mail, Lock } from "lucide-react"
...
function SignUpFormContent() {
  ...
  const content = useContentTranslation({
    ...
    lbl_email: "Email",
    lbl_pass: "Password",
    pass_req: "Requires: 8+ Chars, Mixed Case, Symbols",
        ...
        <form onSubmit={handleSignUp} className="space-y-5">
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2">
              <label className="text-xs font-semibold text-orange-300 uppercase tracking-wider ml-1">{content.lbl_first}</label>
            ...
            <div className="space-y-2">
              <label className="text-xs font-semibold text-orange-300 uppercase tracking-wider ml-1">{content.lbl_last}</label>
              <Input
                placeholder={content.pl_doe}
                value={lastName}
          ...
          <div className="space-y-2">
            <label className="text-xs font-semibold text-orange-300 uppercase tracking-wider ml-1">{content.lbl_email}</label>
            <div className="relative group">
          ...
          <div className="space-y-2">
            <label className="text-xs font-semibold text-orange-300 uppercase tracking-wider ml-1">{content.lbl_pass}</label>
            <div className="relative group">
          ...
          <div className="space-y-3">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-orange-950/10 px-2 text-orange-300/60">{content.or_continue}</span>
              </div>
            </div>
            <Button
              type="button"
          ...
          >
            {isLoading ? content.btn_creating : content.btn_start}
